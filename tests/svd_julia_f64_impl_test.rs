...
#[test]
fn test_julia_f64_svd_correctness() {
...
#[test]
#[ignore] // Ausführen mit 'cargo test --test svd_julia_impl_test benchmark_julia_large_matrix --release -- --ignored'
fn benchmark_julia_large_matrix() {
    println!("Generiere 10000x10000 Zufallsmatrix (f64) für CPU...");
