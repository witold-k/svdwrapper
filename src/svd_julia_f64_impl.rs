...
fn run_julia_svd(
    ...
    let func = Module::main(&frame)
        ...
        .map_err(|e| anyhow!("failed to resolve Julia function svd_cpu_f64: {e}"))?
        .as_value();
...
impl SvdBackend<f64> for JuliaF64Svd {
    fn compute_svd(&self, a: &ArrayBase<impl Data<Elem = f64>, Ix2>, mode: SvdMode) -> SvdResult<f64> {
